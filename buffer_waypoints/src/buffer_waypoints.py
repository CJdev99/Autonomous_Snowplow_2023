...
def clicked_point_callback(clicked_point_msg):
    ...
    goal_msg.target_pose.pose.position = clicked_point_msg.pose.pose.position
    goal_msg.target_pose.pose.orientation = clicked_point_msg.pose.pose.orientation
